...
import { ServiceListPreview } from '../../service_groups/service_group_save/service_list_preview';
            ...
            <EuiFlexGroup>
              ...
              <EuiFlexItem grow={false}>
                ...
                >
                  {!kuery
                    ? i18n.translate(
                        'xpack.apm.serviceDashboard.selectServicesForm.preview',
                        { defaultMessage: 'Preview' }
                      )
                    : i18n.translate(
                        'xpack.apm.serviceDashboard.selectServicesForm.refresh',
            ...
            <EuiFlexItem>
              {kuery && data?.items && (
                <EuiText color="success" size="s">
                  {i18n.translate(
                    'xpack.apm.serviceDashboard.selectServicesForm.matchingServiceCount',
                    {
                      defaultMessage:
                  ...
                  {!kuery && (
                    <CentralizedContainer>
                      <EuiText size="s" color="subdued">
                        {i18n.translate(
                          'xpack.apm.serviceDashboard.selectServicesForm.panelLabel',
